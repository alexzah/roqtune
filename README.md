...
|![Playlist mode (Default theme)](images/screenshot_playlist_mode.png "Optional title") | ![Library mode (Gruvbox light theme)](images/screenshot_library_mode.png "Optional title")|
| -------- | ------- |
|Playlist mode (Default theme) | Library mode (Gruvbox light theme)|
