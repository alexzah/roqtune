...
pub const COLOR_COMPONENT_DEFINITIONS: [(&str, &str); 26] = [
    ("window_bg", "Window Background"),
    ("panel_bg", "Panel Background"),
    ("panel_bg_alt", "Panel Background (Alt)"),
    ("panel_bg_elevated", "Panel Background (Elevated)"),
    ...
    ("accent", "Accent"),
    ("accent_on", "Accent On"),
    ("accent_soft_bg", "Accent Soft Background"),
    ("accent_soft_border", "Accent Soft Border"),
    ("control_hover_bg", "Control Hover Background"),
    ("control_pressed_bg", "Control Pressed Background"),
...
fn color_component_value(colors: &ThemeColorComponents, key: &str) -> String {
    match key {
        ...
        "panel_bg_elevated" => colors.panel_bg_elevated.clone(),
        "overlay_scrim" => colors.overlay_scrim.clone(),
        ...
        "text_disabled" => colors.text_disabled.clone(),
        "accent" => colors.accent.clone(),
        "accent_on" => colors.accent_on.clone(),
        "accent_soft_bg" => colors.accent_soft_bg.clone(),
        "accent_soft_border" => colors.accent_soft_border.clone(),
        "control_hover_bg" => colors.control_hover_bg.clone(),
        "control_pressed_bg" => colors.control_pressed_bg.clone(),
        "selection_bg" => colors.selection_bg.clone(),
        "selection_border" => colors.selection_border.clone(),
        "tooltip_bg" => colors.tooltip_bg.clone(),
        "tooltip_border" => colors.tooltip_border.clone(),
        "tooltip_text" => colors.tooltip_text.clone(),
...
fn set_color_component_value(colors: &mut ThemeColorComponents, key: &str, value: &str) {
    ...
    match key {
        ...
        "panel_bg_elevated" => colors.panel_bg_elevated = normalized,
        "overlay_scrim" => colors.overlay_scrim = normalized,
        "border" => colors.border = normalized,
        "separator" => colors.separator = normalized,
        ...
        "text_disabled" => colors.text_disabled = normalized,
        "accent" => colors.accent = normalized,
        "accent_on" => colors.accent_on = normalized,
        "accent_soft_bg" => colors.accent_soft_bg = normalized,
        "accent_soft_border" => colors.accent_soft_border = normalized,
        "control_hover_bg" => colors.control_hover_bg = normalized,
        "control_pressed_bg" => colors.control_pressed_bg = normalized,
        "selection_bg" => colors.selection_bg = normalized,
        "selection_border" => colors.selection_border = normalized,
        "tooltip_bg" => colors.tooltip_bg = normalized,
        "tooltip_border" => colors.tooltip_border = normalized,
        "tooltip_text" => colors.tooltip_text = normalized,
        "warning" => colors.warning = normalized,
        "danger" => colors.danger = normalized,
        "success" => colors.success = normalized,
        "focus_ring" => colors.focus_ring = normalized,
        _ => {}
    }
}
...
fn sanitize_color_components(
    ...
    ThemeColorComponents {
        ...
        panel_bg_elevated: normalized_or_fallback(
            &candidate.panel_bg_elevated,
            &fallback.panel_bg_elevated,
        ),
        overlay_scrim: normalized_or_fallback(&candidate.overlay_scrim, &fallback.overlay_scrim),
        border: normalized_or_fallback(&candidate.border, &fallback.border),
        separator: normalized_or_fallback(&candidate.separator, &fallback.separator),
        ...
        text_disabled: normalized_or_fallback(&candidate.text_disabled, &fallback.text_disabled),
        ...
        accent_soft_bg: normalized_or_fallback(&candidate.accent_soft_bg, &fallback.accent_soft_bg),
        accent_soft_border: normalized_or_fallback(
            &candidate.accent_soft_border,
            &fallback.accent_soft_border,
        ),
        control_hover_bg: normalized_or_fallback(
            &candidate.control_hover_bg,
            &fallback.control_hover_bg,
        ),
        control_pressed_bg: normalized_or_fallback(
            &candidate.control_pressed_bg,
            &fallback.control_pressed_bg,
        ),
        ...
        tooltip_bg: normalized_or_fallback(&candidate.tooltip_bg, &fallback.tooltip_bg),
        tooltip_border: normalized_or_fallback(&candidate.tooltip_border, &fallback.tooltip_border),
        tooltip_text: normalized_or_fallback(&candidate.tooltip_text, &fallback.tooltip_text),
        ...
        focus_ring: normalized_or_fallback(&candidate.focus_ring, &fallback.focus_ring),
    }
}
