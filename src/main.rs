            ...
            match event {
                ...
                Event::PositionChanged(current_position) => {
                    ...
                    if let Some(ui) = ui_handle_for_events.upgrade() {
                        ...
                        debug!("Updating UI: pos={}, dur={}, pct={}, pos_text={}, dur_text={}",
                               current_position, duration, percentage, 
                               current_pos_text, total_duration_text);
                ...
                Event::TrackLoaded { duration_ms, sample_rate: _, channels: _ } => {
